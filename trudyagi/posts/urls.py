...
urlpatterns = [
    ...
    path('search/<slug:category_slug>/<str:product_name>/', views.search_product_page, name='search_product_page'),
    path('home_search/', views.search_product_home, name='home_search'),
